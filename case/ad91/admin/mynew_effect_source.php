    ...
    <div class="main" id="main">
        ...
        <div class="main_cc">
            <ul class="tag_menu">
                ...
                <li class="current"><a href="mynew_effect_source.php">访问来源</a></li>
                ...
                <ul class="filter">
                    <li class="row">
                        <ul class="filter_element drop_down monospaced_drop_down">
                            <li class="title"><a href="">推广当天<em class="ico"></em></a></li>
                            <li class="options">
                                <a>全部</a>
                            </li>
                        </ul>
            ...
            <table class="chart_data">
                <tr>
                    <td>
                        <div class="chief">第1位:广东</div>
                        <div class="minor">点击:2,183 占比:22.9%</div>
                    </td>
                    <td>
                        <div class="chief">第2位:上海</div>
                        <div class="minor">点击:2,183 占比:22.9%</div>
                    </td>
                    <td>
                        <div class="chief">第3位:北京</div>
                        <div class="minor">点击:2,183 占比:22.9%</div>
                    </td>
                </tr>
            </table>
