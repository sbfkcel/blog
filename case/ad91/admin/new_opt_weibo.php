                ...
                <ul class="filter">
                    <li class="row">
                        ...
                        <div class="custom_term">
                            <label for="" class="name">价格</label>
                            <input class="term str_val" type="text" value="" title="&#165;">
                            <label for="" class="unit">-</label>
                            <input class="term end_val" type="text" value="" title="&#165;">
                            <span class="unit">万</span>
                            <div class="request">
                                <button class="blue_an ct_button">确定</button>
                                <button class="art_an ct_button" onclick="ui.clear_custom_term($(this))">清空</button>
                            </div>
                        </div>
                        <div class="custom_term">
                            <label for="" class="name">粉丝数</label>
                            <input class="term str_val" type="text" value="" title="0">
                            <label for="" class="unit">-</label>
                            <input class="term end_val" type="text" value="" title="">
                            <span class="unit">万</span>
                            <div class="request">
                                <button class="blue_an ct_button" onclick="ui.submit_custom_term()">确定</button>
                                <button class="art_an ct_button" onclick="ui.clear_custom_term($(this))">清空</button>
                            </div>
                        </div>
                        <div class="custom_term">
                            <label for="" class="name">搜索</label>
                            <input class="term search_val" type="text" value="" title="关键字" lang="zh-CN" x-webkit-speech="" x-webkit-grammar="builtin:search">
                            <div class="request">
                                <button class="blue_an ct_button">搜关键字</button>
                                <button class="art_an ct_button" onclick="ui.clear_custom_term($(this))">搜博主</button>
                            </div>
                        </div>
                        <a class="filter_element btn_ico mini_button high_an" href="javascript://" onclick="ui.high_filter_showhide($(this));" ><i class="shrink_ico"></i>更多</a>
                    </li>
